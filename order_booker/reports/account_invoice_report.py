...
class SaleReport(models.Model):
    ...
    def _query(self, with_clause='', fields={}, groupby='', from_clause=''):
        fields['order_booker_id'] = ", move.order_booker_id"
    ...
    def _select(self):
        return super(SaleReport, self)._select() + ", move.order_booker_id"

    def _group_by(self):
        return super(SaleReport, self)._group_by() + ", move.order_booker_id"
