...
class AccountMove(models.Model):
    ...
    #             sign = -1
    #         if move.round_off:
    #             move.amount_untaxed = round(5+(sign * (total_untaxed_currency if len(currencies) == 1 else total_untaxed)))-5
    #         else:
    #             move.amount_untaxed = sign * (total_untaxed_currency if len(currencies) == 1 else total_untaxed)
    #         if move.round_off:
    #             move.amount_tax = round(5+(sign * (total_tax_currency if len(currencies) == 1 else total_tax)))-5
    #         else:
    #             move.amount_tax = sign * (total_tax_currency if len(currencies) == 1 else total_tax)
    #         if move.round_off:
    #             move.amount_total = round(5+(sign * (total_currency if len(currencies) == 1 else total)))-5
    #         else:
    #             move.amount_total = sign * (total_currency if len(currencies) == 1 else total)
    #
    #         if move.round_off:
    #             move.amount_residual = round(5+(-sign * (total_residual_currency if len(currencies) == 1 else total_residual)))-5
    #         else:
    ...
    #                 group.name, round(5+(amounts['amount']))-5,
    #                 round(5+(amounts['base']))-5,
    #                 formatLang(lang_env, round(5+(amounts['amount']))-5, currency_obj=move.currency_id),
    #                 formatLang(lang_env, round(5+(amounts['base']))-5, currency_obj=move.currency_id),
    #                 len(res),
    #                 group.id
